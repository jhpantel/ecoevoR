...
![Hypothesis 3: trait 1 evolves slower than trait 2](file.path(datapath,"output/Figure_2c.svg"))
![Hypothesis 4: trait 1 and 2 correlated](file.path(datapath,"output/Figure_2c.svg"))

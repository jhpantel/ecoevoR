...
## Create landscape
#datapath <- pkgload:::shim_system.file(file.path("extdata", "Example2"), package="ecoevoR")
...
temperature_brick <- brick("input_rasters/temperature_rasters.grd")
aridity_brick <- brick("input_rasters/aridity_rasters.grd")
area_brick <- brick("input_rasters/area_rasters.grd")
...
svg(filename=file.path(datapath,"output/Figure_2b.svg"),width=7,height=7)
plot_gen3sis(sim1,max_gam = max_gam,max_alpha = max_alpha)
dev.off()

svg(filename=file.path(datapath,"output/Figure_2c.svg"),width=7,height=7)
plot_gen3sis(sim2,max_gam=max_gam,max_alpha=max_alpha)
dev.off()

svg(filename=file.path(datapath,"output/Figure_2d.svg"),width=7,height=7)
plot_gen3sis(sim3,max_gam=max_gam,max_alpha=max_alpha)
dev.off()

svg(filename=file.path(datapath,"output/Figure_2e.svg"),width=7,height=7)
plot_gen3sis(sim4,max_gam=max_gam,max_alpha=max_alpha)
dev.off()
```

<embed src=file.path(datapath,"output/Figure_2b.svg") type="image/svg+xml" />
<embed src=file.path(datapath,"output/Figure_2c.svg") type="image/svg+xml" />
<embed src=file.path(datapath,"output/Figure_2d.svg") type="image/svg+xml" />
<embed src=file.path(datapath,"output/Figure_2e.svg") type="image/svg+xml" />

<!-- ![Hypothesis 1: 1 trait evolves](file.path(datapath,"output/Figure_2b.svg")) -->
<!-- ![Hypothesis 2: 2 traits evolve at same rate](file.path(datapath,"output/Figure_2c.svg")) -->
<!-- ![Hypothesis 3: trait 1 evolves slower than trait 2](file.path(datapath,"output/Figure_2d.svg")) -->
<!-- ![Hypothesis 4: trait 1 and 2 correlated](file.path(datapath,"output/Figure_2e.svg")) -->

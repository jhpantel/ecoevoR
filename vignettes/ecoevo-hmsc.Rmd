...
res <- readMat(paste(datapath,"/",result,"_res.mat",sep=""))
N <- res$N
...
x1 <- mpost[,1, drop=FALSE]    

# dat1 - a 15x30x1000 array that gives for each of the 15 species: the intercept, y1-y15 (abundance of species 1-15 in previous year), environmental covariates, and MEM1-13 (spatial eigenvector map) across 1000 iterations. These are the species niches BETA.
dat1 <- mod1$results$estimation$paramX

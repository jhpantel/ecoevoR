...
#cv.modsel <- cv4postpr(abc_sim_mods, abc_sim_summ, nval=5, tol=0.075, method="rejection")
#s <- summary(cv.modsel)
#plot(cv.modsel, names.arg=c("No Evolution", "Evolution"))

#cv.modsel.x0 <- cv4postpr(abc_sim_mods, abc_sim_summ_x0, nval=5, tol=0.075, method="rejection")
#s <- summary(cv.modsel.x0)
# Neural net
#plot(cv.modsel.x0, names.arg=c("No Evolution", "Evolution"))
#cv.modsel.x0 <- cv4postpr(abc_sim_mods, abc_sim_summ_x0, nval=5, tol=0.075, method="neuralnet")
#s <- summary(cv.modsel.x0)
#plot(cv.modsel.x0, names.arg=c("No Evolution", "Evolution"))
```

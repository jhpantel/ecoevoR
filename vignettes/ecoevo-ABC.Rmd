...
pdf(filename=file.path(datapath,"Box_1b.1.pdf"),width=7,height=7)
...
x <- seq(min - 0.5, max + 0.5, 0.01)
pdf(filename=file.path(datapath,"Box_1b.2.pdf"),width=7,height=7)
plot(x, dunif(x, min = min, max = max),
...
db <- dbeta(p, 0.25, 10)
pdf(filename=file.path(datapath,"Box_1b.3.pdf"),width=7,height=7)
...
z_range <- seq(-1,1,.001)
pdf(filename=file.path(datapath,"Box_1b.4.pdf"),width=7,height=7)
...
pdf(filename=file.path(datapath,"Box_1b.5.pdf"),width=7,height=7)
...
pdf(filename=file.path(datapath,"Box_1c.pdf"),width=14,height=14)
...
pdf(filename=file.path(datapath,"Box_1d.1.pdf"),width=7,height=7)
...
pdf(filename=file.path(datapath,"Box_1d.2.pdf"),width=12,height=12)
...
d$y = dscale(d)
pdf(file.path(datapath,"Box_1d.3.pdf"),width=7,height=7)

...
<!-- <embed src=file.path(datapath,"output/Figure_2b.pdf") type="image/svg+xml" />
...
![Hypothesis 1: 1 trait evolves](file.path(datapath,"output/Figure_2b.pdf"))
![Hypothesis 2: 2 traits evolve at same rate](file.path(datapath,"output/Figure_2c.pdf"))
![Hypothesis 3: trait 1 evolves slower than trait 2](file.path(datapath,"output/Figure_2d.pdf"))
![Hypothesis 4: trait 1 and 2 correlated](file.path(datapath,"output/Figure_2e.pdf"))

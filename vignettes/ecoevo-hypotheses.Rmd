...
datapath <- here::here("extdata", "Example2")
...
pdf(file=file.path(datapath,"output/Figure_2b.pdf"),width=7,height=7)
plot_gen3sis(sim1,max_gam = max_gam,max_alpha = max_alpha)
dev.off()

pdf(file=file.path(datapath,"output/Figure_2c.pdf"),width=7,height=7)
plot_gen3sis(sim2,max_gam=max_gam,max_alpha=max_alpha)
dev.off()

pdf(file=file.path(datapath,"output/Figure_2d.pdf"),width=7,height=7)
plot_gen3sis(sim3,max_gam=max_gam,max_alpha=max_alpha)
dev.off()

pdf(file=file.path(datapath,"output/Figure_2e.pdf"),width=7,height=7)
